...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'profile', component: Profile, title: 'Mi Perfil | JMJ Viajes', canActivate: [AuthGuard] },
      { path: 'settings', component: Settings, title: 'Ajustes | JMJ Viajes', canActivate: [AuthGuard] },
      { path: 'add-card', component: AddCard, title: 'Añadir Tarjeta | JMJ Viajes', canActivate: [AuthGuard] },
      ...
      { path: 'receipt/:hotelId', component: Receipt, title: 'Recibo | JMJ Viajes', canActivate: [AuthGuard] },
      { path: 'trips', component: Trips, title: 'Mis Viajes | JMJ Viajes', canActivate: [AuthGuard] },

      // CMS / Panel de administración
      { path: 'admin', component: AdminDashboard, title: 'Panel Admin | JMJ Viajes', canActivate: [AuthGuard] },
      { path: 'admin/users', component: AdminDashboard, title: 'Gestión de Usuarios | JMJ Viajes', canActivate: [AuthGuard] },
    ],
  },
  { path: '**', redirectTo: '' },
];
